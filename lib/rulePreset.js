...
export const swipeSet = [
  // {
  //   ifType: "action",
  //   thenType: "interface",
  //   thenDetail: ["circle", "#000000", 200, "swipe me"],
  //   left: ["color", "#FFB800"],
  //   right: ["color", "#3083FF"],
  //   up: ["color", "#FF7A52"],
  //   down: ["color", "#07C072"],
...
export const hoverClickSet = [
  {
    ifType: "action",
    thenType: "interface",
    thenDetail: ["rect", "#000000", 200, "point here, okay to click"],
    hover: ["color", "#BAAFFD"],
    click: ["color", "#9788F5", "okay"],
  },
];
